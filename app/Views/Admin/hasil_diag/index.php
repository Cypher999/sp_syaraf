...
<head><title>Hasil diagnosa</title>
	<?php require_once 'app/Views/Admin/hasil_diag/partials/header.php';?>
</head>
<body>
...
<thead>
				...
				<tr>
                    ...
                    <td><a class="text-danger btn btn-small" href="?a=Hasil_diag/Del&&key=<?php echo $hasil_diag["tgl"];?>" title="Hapus Data"><i class="fas fa-trash"></i></a>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="bordered" action="?a=Hasil_diag/insert" method="post" enctype="multipart/form-data"> 
							...
							<input type="text" name="nm_pasien" class="form-control" placeholder="pasien.">
		...
		<?php require_once 'app/Views/Admin/hasil_diag/partials/js.php';?>
</body>
